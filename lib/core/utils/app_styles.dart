...
class AppStyles {
  ...
  static TextStyle introTitleStyle = TextStyle(
      fontFamily: "Poppins",
      fontSize: 20.sp,
      fontWeight: FontWeight.w700,
      color: AppColors.titleColor);
  static TextStyle pickerHintStyle = TextStyle(
      fontFamily: "Inter",
      fontSize: 18.sp,
      fontWeight: FontWeight.w500,
      color: Colors.black);
  static TextStyle pickerInstructionsStyle = TextStyle(
      fontFamily: "Inter",
      fontSize: 11.sp,
      fontWeight: FontWeight.w500,
      color: AppColors.instructionsColor);
  static TextStyle smallTextStyle = TextStyle(
      fontSize: 12.sp, color: AppColors.primaryColor, fontFamily: "Poppins");
  static ButtonStyle loginButtonStyle = ElevatedButton.styleFrom(
      padding: EdgeInsets.symmetric(vertical: 15.h, horizontal: 115.w),
      backgroundColor: AppColors.primaryColor,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(18.r)));
  static ButtonStyle portfolioDetailsButtonStyle = ElevatedButton.styleFrom(
      padding: EdgeInsets.symmetric(vertical: 9.h),
      backgroundColor: AppColors.primaryColor,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16.r)));
  static ButtonStyle sendButtonStyle = ElevatedButton.styleFrom(
      padding: EdgeInsets.symmetric(vertical: 15.h, horizontal: 112.w),
      backgroundColor: AppColors.primaryColor,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(18.r)));
